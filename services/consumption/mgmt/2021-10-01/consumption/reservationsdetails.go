...
// Parameters:
// resourceScope - the scope associated with reservations details operations. This includes
...
// reservation order
func (client ReservationsDetailsClient) List(ctx context.Context, resourceScope string, startDate string, endDate string, filter string, reservationID string, reservationOrderID string) (result ReservationDetailsListResultPage, err error) {
	...
	req, err := client.ListPreparer(ctx, resourceScope, startDate, endDate, filter, reservationID, reservationOrderID)
	if err != nil {
...
func (client ReservationsDetailsClient) ListPreparer(ctx context.Context, resourceScope string, startDate string, endDate string, filter string, reservationID string, reservationOrderID string) (*http.Request, error) {
	...
	preparer := autorest.CreatePreparer(
		...
		autorest.WithPathParameters("/{resourceScope}/providers/Microsoft.Consumption/reservationDetails", pathParameters),
...
func (client ReservationsDetailsClient) ListComplete(ctx context.Context, resourceScope string, startDate string, endDate string, filter string, reservationID string, reservationOrderID string) (result ReservationDetailsListResultIterator, err error) {
	if tracing.IsEnabled() {
		ctx = tracing.StartSpan(ctx, fqdn+"/ReservationsDetailsClient.List")
		defer func() {
			sc := -1
	...
	result.page, err = client.List(ctx, resourceScope, startDate, endDate, filter, reservationID, reservationOrderID)
	return
}
