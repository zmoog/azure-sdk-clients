...
const (
	// CreditExpired ...
	CreditExpired EventType = "CreditExpired"
	// NewCredit ...
...
func PossibleEventTypeValues() []EventType {
	return []EventType{CreditExpired, NewCredit, PendingAdjustments, PendingCharges, PendingExpiredCredit, PendingNewCredit, SettledCharges, UnKnown}
}
...
const (
	...
	ConsumptionCommitment LotSource = "ConsumptionCommitment"
	// PromotionalCredit ...
...
func PossibleLotSourceValues() []LotSource {
	return []LotSource{ConsumptionCommitment, PromotionalCredit, PurchasedCredit}
}
...
// PricingModelType enumerates the values for pricing model type.
type PricingModelType string

const (
	// OnDemand ...
	OnDemand PricingModelType = "On Demand"
	// Reservation ...
	Reservation PricingModelType = "Reservation"
	// Spot ...
	Spot PricingModelType = "Spot"
)

// PossiblePricingModelTypeValues returns an array of possible values for the PricingModelType const type.
func PossiblePricingModelTypeValues() []PricingModelType {
	return []PricingModelType{OnDemand, Reservation, Spot}
}
...
const (
	// ScopeLegacyReservationRecommendationProperties ...
	ScopeLegacyReservationRecommendationProperties Scope = "LegacyReservationRecommendationProperties"
	// ScopeShared ...
...
func PossibleScopeValues() []Scope {
	return []Scope{ScopeLegacyReservationRecommendationProperties, ScopeShared, ScopeSingle}
}

// Scope5 enumerates the values for scope 5.
type Scope5 string

const (
	// Shared ...
	Shared Scope5 = "Shared"
	// Single ...
	Single Scope5 = "Single"
)

// PossibleScope5Values returns an array of possible values for the Scope5 const type.
func PossibleScope5Values() []Scope5 {
	return []Scope5{Shared, Single}
}

// Scope7 enumerates the values for scope 7.
type Scope7 string

const (
	// Scope7Shared ...
	Scope7Shared Scope7 = "Shared"
	// Scope7Single ...
	Scope7Single Scope7 = "Single"
)

// PossibleScope7Values returns an array of possible values for the Scope7 const type.
func PossibleScope7Values() []Scope7 {
	return []Scope7{Scope7Shared, Scope7Single}
}
...
func PossibleStatusValues() []Status {
	return []Status{Active, Canceled, Complete, Expired, Inactive, None}
}
...
const (
	...
	// Forecasted ...
	Forecasted ThresholdType = "Forecasted"
)
...
func PossibleThresholdTypeValues() []ThresholdType {
	return []ThresholdType{Actual, Forecasted}
}
...
const (
	...
	// BillingAnnual ...
	BillingAnnual TimeGrainType = "BillingAnnual"
	// BillingMonth ...
	BillingMonth TimeGrainType = "BillingMonth"
	// BillingQuarter ...
	BillingQuarter TimeGrainType = "BillingQuarter"
	// Monthly ...
...
func PossibleTimeGrainTypeValues() []TimeGrainType {
	return []TimeGrainType{Annually, BillingAnnual, BillingMonth, BillingQuarter, Monthly, Quarterly}
}
