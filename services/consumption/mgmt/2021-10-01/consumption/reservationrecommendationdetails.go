...
// Parameters:
// resourceScope - the scope associated with reservation recommendation details operations. This includes
...
func (client ReservationRecommendationDetailsClient) Get(ctx context.Context, resourceScope string, scope Scope7, region string, term Term, lookBackPeriod LookBackPeriod, product string) (result ReservationRecommendationDetailsModel, err error) {
	...
	req, err := client.GetPreparer(ctx, resourceScope, scope, region, term, lookBackPeriod, product)
	if err != nil {
...
func (client ReservationRecommendationDetailsClient) GetPreparer(ctx context.Context, resourceScope string, scope Scope7, region string, term Term, lookBackPeriod LookBackPeriod, product string) (*http.Request, error) {
	...
	preparer := autorest.CreatePreparer(
		...
		autorest.WithPathParameters("/{resourceScope}/providers/Microsoft.Consumption/reservationRecommendationDetails", pathParameters),
