...
type AmountWithExchangeRate struct {
	// ExchangeRate - READ-ONLY; The exchange rate.
	ExchangeRate *decimal.Decimal `json:"exchangeRate,omitempty"`
	// ExchangeRateMonth - READ-ONLY; The exchange rate month.
	ExchangeRateMonth *int32 `json:"exchangeRateMonth,omitempty"`
	// Currency - READ-ONLY; Amount currency.
	Currency *string `json:"currency,omitempty"`
	// Value - READ-ONLY; Amount.
	Value *decimal.Decimal `json:"value,omitempty"`
...
type Balance struct {
	...
	*BalanceProperties `json:"properties,omitempty"`
	// ID - READ-ONLY; The full qualified ARM ID of an event.
	ID *string `json:"id,omitempty"`
	// Name - READ-ONLY; The ID that uniquely identifies an event.
	Name *string `json:"name,omitempty"`
	// Type - READ-ONLY; Resource type.
	Type *string `json:"type,omitempty"`
	// Etag - READ-ONLY; The etag for the resource.
...
type BudgetProperties struct {
	...
	// TimeGrain - The time covered by a budget. Tracking of the amount will be reset based on the time grain. BillingMonth, BillingQuarter, and BillingAnnual are only supported by WD customers. Possible values include: 'Monthly', 'Quarterly', 'Annually', 'BillingMonth', 'BillingQuarter', 'BillingAnnual'
...
type CreditBalanceSummary struct {
	...
	// EstimatedBalanceInBillingCurrency - READ-ONLY; Estimated balance in billing currency.
...
type CreditSummaryProperties struct {
	...
	// CreditCurrency - READ-ONLY; The credit currency.
	CreditCurrency *string `json:"creditCurrency,omitempty"`
	// BillingCurrency - READ-ONLY; The billing currency.
	BillingCurrency *string `json:"billingCurrency,omitempty"`
	// Reseller - READ-ONLY; Credit's reseller.
...
type EventProperties struct {
	// TransactionDate - READ-ONLY; The date of the event.
	TransactionDate *date.Time `json:"transactionDate,omitempty"`
	// Description - READ-ONLY; The description of the event.
	Description *string `json:"description,omitempty"`
	// NewCredit - READ-ONLY; The amount of new credit or commitment for NewCredit or SettleCharges event.
	NewCredit *Amount `json:"newCredit,omitempty"`
	// Adjustments - READ-ONLY; The amount of balance adjustment. The property is not available for ConsumptionCommitment lots.
	Adjustments *Amount `json:"adjustments,omitempty"`
	// CreditExpired - READ-ONLY; The amount of expired credit or commitment for NewCredit or SettleCharges event.
	CreditExpired *Amount `json:"creditExpired,omitempty"`
	// Charges - READ-ONLY; The amount of charges for events of type SettleCharges and PendingEligibleCharges.
	Charges *Amount `json:"charges,omitempty"`
	// ClosedBalance - READ-ONLY; The balance after the event.
	ClosedBalance *Amount `json:"closedBalance,omitempty"`
	// EventType - Identifies the type of the event. Possible values include: 'SettledCharges', 'PendingCharges', 'PendingAdjustments', 'PendingNewCredit', 'PendingExpiredCredit', 'UnKnown', 'NewCredit', 'CreditExpired'
	EventType EventType `json:"eventType,omitempty"`
	// InvoiceNumber - READ-ONLY; The number which uniquely identifies the invoice on which the event was billed. This will be empty for unbilled events.
	InvoiceNumber *string `json:"invoiceNumber,omitempty"`
	// BillingProfileID - READ-ONLY; The ID that uniquely identifies the billing profile for which the event happened. The property is only available for billing account of type MicrosoftCustomerAgreement.
	BillingProfileID *string `json:"billingProfileId,omitempty"`
	// BillingProfileDisplayName - READ-ONLY; The display name of the billing profile for which the event happened. The property is only available for billing account of type MicrosoftCustomerAgreement.
	BillingProfileDisplayName *string `json:"billingProfileDisplayName,omitempty"`
	// LotID - READ-ONLY; The ID that uniquely identifies the lot for which the event happened.
	LotID *string `json:"lotId,omitempty"`
	// LotSource - READ-ONLY; Identifies the source of the lot for which the event happened.
	LotSource *string `json:"lotSource,omitempty"`
	// CanceledCredit - READ-ONLY; Amount of canceled credit.
	CanceledCredit *Amount `json:"canceledCredit,omitempty"`
	// CreditCurrency - READ-ONLY; The credit currency of the event.
	CreditCurrency *string `json:"creditCurrency,omitempty"`
	// BillingCurrency - READ-ONLY; The billing currency of the event.
	BillingCurrency *string `json:"billingCurrency,omitempty"`
	// Reseller - READ-ONLY; The reseller of the event.
	Reseller *Reseller `json:"reseller,omitempty"`
	// CreditExpiredInBillingCurrency - READ-ONLY; The amount of expired credit or commitment for NewCredit or SettleCharges event in billing currency.
	CreditExpiredInBillingCurrency *AmountWithExchangeRate `json:"creditExpiredInBillingCurrency,omitempty"`
	// NewCreditInBillingCurrency - READ-ONLY; The amount of new credit or commitment for NewCredit or SettleCharges event in billing currency.
	NewCreditInBillingCurrency *AmountWithExchangeRate `json:"newCreditInBillingCurrency,omitempty"`
	// AdjustmentsInBillingCurrency - READ-ONLY; The amount of balance adjustment in billing currency.
	AdjustmentsInBillingCurrency *AmountWithExchangeRate `json:"adjustmentsInBillingCurrency,omitempty"`
	// ChargesInBillingCurrency - READ-ONLY; The amount of charges for events of type SettleCharges and PendingEligibleCharges in billing currency.
	ChargesInBillingCurrency *AmountWithExchangeRate `json:"chargesInBillingCurrency,omitempty"`
	// ClosedBalanceInBillingCurrency - READ-ONLY; The balance in billing currency after the event.
...
type LegacyReservationRecommendation struct {
	// BasicLegacyReservationRecommendationProperties - Properties for legacy reservation recommendation
	BasicLegacyReservationRecommendationProperties `json:"properties,omitempty"`
	// ID - READ-ONLY; The full qualified ARM ID of an event.
	ID *string `json:"id,omitempty"`
	// Name - READ-ONLY; The ID that uniquely identifies an event.
	Name *string `json:"name,omitempty"`
...
func (lrr LegacyReservationRecommendation) MarshalJSON() ([]byte, error) {
	...
	objectMap := make(map[string]interface{})
	objectMap["properties"] = lrr.BasicLegacyReservationRecommendationProperties
	if lrr.Kind != "" {
...
func (lrr *LegacyReservationRecommendation) UnmarshalJSON(body []byte) error {
	...
	for k, v := range m {
		...
		case "properties":
			if v != nil {
				basicLegacyReservationRecommendationProperties, err := unmarshalBasicLegacyReservationRecommendationProperties(*v)
				if err != nil {
					return err
				}
				lrr.BasicLegacyReservationRecommendationProperties = basicLegacyReservationRecommendationProperties
			}
		case "id":
			if v != nil {
				var ID string
...
// BasicLegacyReservationRecommendationProperties the properties of the reservation recommendation.
type BasicLegacyReservationRecommendationProperties interface {
	AsLegacySingleScopeReservationRecommendationProperties() (*LegacySingleScopeReservationRecommendationProperties, bool)
	AsLegacySharedScopeReservationRecommendationProperties() (*LegacySharedScopeReservationRecommendationProperties, bool)
	AsLegacyReservationRecommendationProperties() (*LegacyReservationRecommendationProperties, bool)
}
...
type LegacyReservationRecommendationProperties struct {
	...
	// Scope - Possible values include: 'ScopeLegacyReservationRecommendationProperties', 'ScopeSingle', 'ScopeShared'
	Scope Scope `json:"scope,omitempty"`
}

func unmarshalBasicLegacyReservationRecommendationProperties(body []byte) (BasicLegacyReservationRecommendationProperties, error) {
	var m map[string]interface{}
	err := json.Unmarshal(body, &m)
	if err != nil {
		return nil, err
	...
	case string(ScopeSingle):
		var lssrrp LegacySingleScopeReservationRecommendationProperties
		err := json.Unmarshal(body, &lssrrp)
		return lssrrp, err
	case string(ScopeShared):
		var lssrrp LegacySharedScopeReservationRecommendationProperties
		err := json.Unmarshal(body, &lssrrp)
		return lssrrp, err
	default:
		var lrrp LegacyReservationRecommendationProperties
		err := json.Unmarshal(body, &lrrp)
		return lrrp, err
	}
}
func unmarshalBasicLegacyReservationRecommendationPropertiesArray(body []byte) ([]BasicLegacyReservationRecommendationProperties, error) {
	var rawMessages []*json.RawMessage
	err := json.Unmarshal(body, &rawMessages)
	if err != nil {
		return nil, err
	...
	lrrpArray := make([]BasicLegacyReservationRecommendationProperties, len(rawMessages))

	for index, rawMessage := range rawMessages {
		lrrp, err := unmarshalBasicLegacyReservationRecommendationProperties(*rawMessage)
		if err != nil {
			return nil, err
		}
		lrrpArray[index] = lrrp
	}
	return lrrpArray, nil
}
...
func (lrrp LegacyReservationRecommendationProperties) MarshalJSON() ([]byte, error) {
	lrrp.Scope = ScopeLegacyReservationRecommendationProperties
	objectMap := make(map[string]interface{})
	if lrrp.Scope != "" {
		objectMap["scope"] = lrrp.Scope
	}
	return json.Marshal(objectMap)
}

// AsLegacySingleScopeReservationRecommendationProperties is the BasicLegacyReservationRecommendationProperties implementation for LegacyReservationRecommendationProperties.
func (lrrp LegacyReservationRecommendationProperties) AsLegacySingleScopeReservationRecommendationProperties() (*LegacySingleScopeReservationRecommendationProperties, bool) {
	return nil, false
}

// AsLegacySharedScopeReservationRecommendationProperties is the BasicLegacyReservationRecommendationProperties implementation for LegacyReservationRecommendationProperties.
func (lrrp LegacyReservationRecommendationProperties) AsLegacySharedScopeReservationRecommendationProperties() (*LegacySharedScopeReservationRecommendationProperties, bool) {
	return nil, false
}

// AsLegacyReservationRecommendationProperties is the BasicLegacyReservationRecommendationProperties implementation for LegacyReservationRecommendationProperties.
func (lrrp LegacyReservationRecommendationProperties) AsLegacyReservationRecommendationProperties() (*LegacyReservationRecommendationProperties, bool) {
	return &lrrp, true
}

// AsBasicLegacyReservationRecommendationProperties is the BasicLegacyReservationRecommendationProperties implementation for LegacyReservationRecommendationProperties.
func (lrrp LegacyReservationRecommendationProperties) AsBasicLegacyReservationRecommendationProperties() (BasicLegacyReservationRecommendationProperties, bool) {
	return &lrrp, true
}
...
type LegacyReservationTransactionProperties struct {
	...
	// BillingMonth - READ-ONLY; The billing month(yyyyMMdd), on which the event initiated.
	BillingMonth *int32 `json:"billingMonth,omitempty"`
	// MonetaryCommitment - READ-ONLY; The monetary commitment amount at the enrollment scope.
	MonetaryCommitment *decimal.Decimal `json:"monetaryCommitment,omitempty"`
	// Overage - READ-ONLY; The overage amount at the enrollment scope.
	Overage *decimal.Decimal `json:"overage,omitempty"`
}
...
// LegacySharedScopeReservationRecommendationProperties the properties of the legacy reservation
// recommendation for shared scope.
...
// MarshalJSON is the custom marshaler for LegacySharedScopeReservationRecommendationProperties.
func (lssrrp LegacySharedScopeReservationRecommendationProperties) MarshalJSON() ([]byte, error) {
	lssrrp.Scope = ScopeShared
	objectMap := make(map[string]interface{})
	if lssrrp.Scope != "" {
		objectMap["scope"] = lssrrp.Scope
	}
	return json.Marshal(objectMap)
}

// AsLegacySingleScopeReservationRecommendationProperties is the BasicLegacyReservationRecommendationProperties implementation for LegacySharedScopeReservationRecommendationProperties.
func (lssrrp LegacySharedScopeReservationRecommendationProperties) AsLegacySingleScopeReservationRecommendationProperties() (*LegacySingleScopeReservationRecommendationProperties, bool) {
	return nil, false
}

// AsLegacySharedScopeReservationRecommendationProperties is the BasicLegacyReservationRecommendationProperties implementation for LegacySharedScopeReservationRecommendationProperties.
func (lssrrp LegacySharedScopeReservationRecommendationProperties) AsLegacySharedScopeReservationRecommendationProperties() (*LegacySharedScopeReservationRecommendationProperties, bool) {
	return &lssrrp, true
}

// AsLegacyReservationRecommendationProperties is the BasicLegacyReservationRecommendationProperties implementation for LegacySharedScopeReservationRecommendationProperties.
func (lssrrp LegacySharedScopeReservationRecommendationProperties) AsLegacyReservationRecommendationProperties() (*LegacyReservationRecommendationProperties, bool) {
	return nil, false
}

// AsBasicLegacyReservationRecommendationProperties is the BasicLegacyReservationRecommendationProperties implementation for LegacySharedScopeReservationRecommendationProperties.
func (lssrrp LegacySharedScopeReservationRecommendationProperties) AsBasicLegacyReservationRecommendationProperties() (BasicLegacyReservationRecommendationProperties, bool) {
	return &lssrrp, true
}

// LegacySingleScopeReservationRecommendationProperties the properties of the legacy reservation
// recommendation for single scope.
type LegacySingleScopeReservationRecommendationProperties struct {
	// SubscriptionID - READ-ONLY; Subscription id associated with single scoped recommendation.
...
// MarshalJSON is the custom marshaler for LegacySingleScopeReservationRecommendationProperties.
func (lssrrp LegacySingleScopeReservationRecommendationProperties) MarshalJSON() ([]byte, error) {
	lssrrp.Scope = ScopeSingle
	objectMap := make(map[string]interface{})
	if lssrrp.Scope != "" {
		objectMap["scope"] = lssrrp.Scope
	}
...
// AsLegacySingleScopeReservationRecommendationProperties is the BasicLegacyReservationRecommendationProperties implementation for LegacySingleScopeReservationRecommendationProperties.
func (lssrrp LegacySingleScopeReservationRecommendationProperties) AsLegacySingleScopeReservationRecommendationProperties() (*LegacySingleScopeReservationRecommendationProperties, bool) {
	return &lssrrp, true
}

// AsLegacySharedScopeReservationRecommendationProperties is the BasicLegacyReservationRecommendationProperties implementation for LegacySingleScopeReservationRecommendationProperties.
func (lssrrp LegacySingleScopeReservationRecommendationProperties) AsLegacySharedScopeReservationRecommendationProperties() (*LegacySharedScopeReservationRecommendationProperties, bool) {
	return nil, false
}

// AsLegacyReservationRecommendationProperties is the BasicLegacyReservationRecommendationProperties implementation for LegacySingleScopeReservationRecommendationProperties.
func (lssrrp LegacySingleScopeReservationRecommendationProperties) AsLegacyReservationRecommendationProperties() (*LegacyReservationRecommendationProperties, bool) {
	return nil, false
}

// AsBasicLegacyReservationRecommendationProperties is the BasicLegacyReservationRecommendationProperties implementation for LegacySingleScopeReservationRecommendationProperties.
func (lssrrp LegacySingleScopeReservationRecommendationProperties) AsBasicLegacyReservationRecommendationProperties() (BasicLegacyReservationRecommendationProperties, bool) {
	return &lssrrp, true
}
...
type LegacyUsageDetailProperties struct {
	...
	// ResourceID - READ-ONLY; Unique identifier of the Azure Resource Manager usage detail resource.
	ResourceID *string `json:"resourceId,omitempty"`
	// ResourceName - READ-ONLY; Resource Name.
	ResourceName *string `json:"resourceName,omitempty"`
	// ServiceInfo1 - READ-ONLY; Service-specific metadata.
	ServiceInfo1 *string `json:"serviceInfo1,omitempty"`
	// ServiceInfo2 - READ-ONLY; Legacy field with optional service-specific metadata.
	...
	// BenefitID - READ-ONLY; Unique identifier for the applicable benefit.
	BenefitID *string `json:"benefitId,omitempty"`
	// BenefitName - READ-ONLY; Name of the applicable benefit.
	BenefitName *string `json:"benefitName,omitempty"`
	// PricingModel - READ-ONLY; Identifier that indicates how the meter is priced. Possible values include: 'OnDemand', 'Reservation', 'Spot'
...
type LotProperties struct {
	// OriginalAmount - READ-ONLY; The original amount of a lot.
	OriginalAmount *Amount `json:"originalAmount,omitempty"`
	// ClosedBalance - READ-ONLY; The balance as of the last invoice.
	ClosedBalance *Amount `json:"closedBalance,omitempty"`
	// Source - READ-ONLY; The source of the lot. Possible values include: 'PurchasedCredit', 'PromotionalCredit', 'ConsumptionCommitment'
	Source LotSource `json:"source,omitempty"`
	// StartDate - READ-ONLY; The date when the lot became effective.
	StartDate *date.Time `json:"startDate,omitempty"`
	// ExpirationDate - READ-ONLY; The expiration date of a lot.
	ExpirationDate *date.Time `json:"expirationDate,omitempty"`
	// PoNumber - READ-ONLY; The po number of the invoice on which the lot was added. This property is not available for ConsumptionCommitment lots.
	PoNumber *string `json:"poNumber,omitempty"`
	// PurchasedDate - READ-ONLY; The date when the lot was added.
	PurchasedDate *date.Time `json:"purchasedDate,omitempty"`
	// Status - READ-ONLY; The status of the lot. Possible values include: 'None', 'Active', 'Inactive', 'Expired', 'Complete', 'Canceled'
	Status Status `json:"status,omitempty"`
	// CreditCurrency - READ-ONLY; The currency of the lot.
	CreditCurrency *string `json:"creditCurrency,omitempty"`
	// BillingCurrency - READ-ONLY; The billing currency of the lot.
	BillingCurrency *string `json:"billingCurrency,omitempty"`
	// OriginalAmountInBillingCurrency - READ-ONLY; The original amount of a lot in billing currency.
	OriginalAmountInBillingCurrency *AmountWithExchangeRate `json:"originalAmountInBillingCurrency,omitempty"`
	// ClosedBalanceInBillingCurrency - READ-ONLY; The balance as of the last invoice in billing currency.
	ClosedBalanceInBillingCurrency *AmountWithExchangeRate `json:"closedBalanceInBillingCurrency,omitempty"`
	// Reseller - READ-ONLY; The reseller of the lot.
	Reseller *Reseller `json:"reseller,omitempty"`
	// ETag - READ-ONLY; The eTag for the resource.
	ETag *string `json:"eTag,omitempty"`
}
...
type ModernUsageDetailProperties struct {
	...
	// BenefitName - READ-ONLY; Name of the applicable benefit.
	BenefitName *string `json:"benefitName,omitempty"`
	// Provider - READ-ONLY; Identifier for Product Category or Line Of Business, Ex - Azure, Microsoft 365, AWS e.t.c
	Provider *string `json:"provider,omitempty"`
	// CostAllocationRuleName - READ-ONLY; Name for Cost Allocation Rule.
...
type Notification struct {
	...
	// ThresholdType - The type of threshold. Possible values include: 'Actual', 'Forecasted'
	ThresholdType ThresholdType `json:"thresholdType,omitempty"`
	// Locale - Language in which the recipient will receive the notification. Possible values include: 'EnUs', 'JaJp', 'ZhCn', 'DeDe', 'EsEs', 'FrFr', 'ItIt', 'KoKr', 'PtBr', 'RuRu', 'ZhTw', 'CsCz', 'PlPl', 'TrTr', 'DaDk', 'EnGb', 'HuHu', 'NbNo', 'NlNl', 'PtPt', 'SvSe'
...
type Reseller struct {
	// ResellerID - READ-ONLY; The reseller property ID.
	ResellerID *string `json:"resellerId,omitempty"`
	// ResellerDescription - READ-ONLY; The reseller property description.
