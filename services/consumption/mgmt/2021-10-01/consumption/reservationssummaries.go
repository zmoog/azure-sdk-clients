...
// Parameters:
// resourceScope - the scope associated with reservations summaries operations. This includes
...
// reservation order
func (client ReservationsSummariesClient) List(ctx context.Context, resourceScope string, grain Datagrain, startDate string, endDate string, filter string, reservationID string, reservationOrderID string) (result ReservationSummariesListResultPage, err error) {
	...
	req, err := client.ListPreparer(ctx, resourceScope, grain, startDate, endDate, filter, reservationID, reservationOrderID)
	if err != nil {
...
func (client ReservationsSummariesClient) ListPreparer(ctx context.Context, resourceScope string, grain Datagrain, startDate string, endDate string, filter string, reservationID string, reservationOrderID string) (*http.Request, error) {
	...
	preparer := autorest.CreatePreparer(
		...
		autorest.WithPathParameters("/{resourceScope}/providers/Microsoft.Consumption/reservationSummaries", pathParameters),
...
func (client ReservationsSummariesClient) ListComplete(ctx context.Context, resourceScope string, grain Datagrain, startDate string, endDate string, filter string, reservationID string, reservationOrderID string) (result ReservationSummariesListResultIterator, err error) {
	if tracing.IsEnabled() {
		ctx = tracing.StartSpan(ctx, fqdn+"/ReservationsSummariesClient.List")
		defer func() {
			sc := -1
	...
	result.page, err = client.List(ctx, resourceScope, grain, startDate, endDate, filter, reservationID, reservationOrderID)
	return
}
