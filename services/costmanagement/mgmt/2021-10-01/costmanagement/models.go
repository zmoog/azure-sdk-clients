...
const fqdn = "generated/costmanagement/2021-10-01"
...
type AlertProperties struct {
	...
	// StatusModificationUserName - User who last modified the alert
...
type AlertPropertiesDetails struct {
	...
	// EnrollmentStartDate - datetime of enrollmentStartDate
	EnrollmentStartDate *string `json:"enrollmentStartDate,omitempty"`
	// EnrollmentEndDate - datetime of enrollmentEndDate
	EnrollmentEndDate *string `json:"enrollmentEndDate,omitempty"`
	// InvoicingThreshold - invoicing threshold
	InvoicingThreshold *decimal.Decimal `json:"invoicingThreshold,omitempty"`
}
...
type Dimension struct {
	*DimensionProperties `json:"properties,omitempty"`
	...
	// Type - READ-ONLY; Resource type.
	Type *string `json:"type,omitempty"`
	// Location - READ-ONLY; Location of the resource.
	Location *string `json:"location,omitempty"`
	// Sku - READ-ONLY; SKU of the resource.
...
// GenerateReservationDetailsReportByBillingAccountIDFuture an abstraction for monitoring and retrieving
...
func (future *GenerateReservationDetailsReportByBillingAccountIDFuture) UnmarshalJSON(body []byte) error {
...
// result is the default implementation for GenerateReservationDetailsReportByBillingAccountIDFuture.Result.
func (future *GenerateReservationDetailsReportByBillingAccountIDFuture) result(client GenerateReservationDetailsReportClient) (osVar OperationStatus, err error) {
	var done bool
	done, err = future.DoneWithContext(context.Background(), client)
	if err != nil {
		err = autorest.NewErrorWithError(err, "costmanagement.GenerateReservationDetailsReportByBillingAccountIDFuture", "Result", future.Response(), "Polling failure")
		return
	}
	if !done {
		osVar.Response.Response = future.Response()
		err = azure.NewAsyncOpIncompleteError("costmanagement.GenerateReservationDetailsReportByBillingAccountIDFuture")
		return
	}
	...
	if osVar.Response.Response, err = future.GetResult(sender); err == nil && osVar.Response.Response.StatusCode != http.StatusNoContent {
		osVar, err = client.ByBillingAccountIDResponder(osVar.Response.Response)
		if err != nil {
			err = autorest.NewErrorWithError(err, "costmanagement.GenerateReservationDetailsReportByBillingAccountIDFuture", "Result", osVar.Response.Response, "Failure responding to request")
		}
	}
	return
}

// GenerateReservationDetailsReportByBillingProfileIDFuture an abstraction for monitoring and retrieving
// the results of a long-running operation.
...
// UnmarshalJSON is the custom unmarshaller for CreateFuture.
func (future *GenerateReservationDetailsReportByBillingProfileIDFuture) UnmarshalJSON(body []byte) error {
	var azFuture azure.Future
	if err := json.Unmarshal(body, &azFuture); err != nil {
		return err
	}
...
// result is the default implementation for GenerateReservationDetailsReportByBillingProfileIDFuture.Result.
func (future *GenerateReservationDetailsReportByBillingProfileIDFuture) result(client GenerateReservationDetailsReportClient) (osVar OperationStatus, err error) {
	var done bool
	done, err = future.DoneWithContext(context.Background(), client)
	if err != nil {
		err = autorest.NewErrorWithError(err, "costmanagement.GenerateReservationDetailsReportByBillingProfileIDFuture", "Result", future.Response(), "Polling failure")
		return
	}
	if !done {
		osVar.Response.Response = future.Response()
		err = azure.NewAsyncOpIncompleteError("costmanagement.GenerateReservationDetailsReportByBillingProfileIDFuture")
		return
	}
	sender := autorest.DecorateSender(client, autorest.DoRetryForStatusCodes(client.RetryAttempts, client.RetryDuration, autorest.StatusCodesForRetry...))
	if osVar.Response.Response, err = future.GetResult(sender); err == nil && osVar.Response.Response.StatusCode != http.StatusNoContent {
		osVar, err = client.ByBillingProfileIDResponder(osVar.Response.Response)
		if err != nil {
			err = autorest.NewErrorWithError(err, "costmanagement.GenerateReservationDetailsReportByBillingProfileIDFuture", "Result", osVar.Response.Response, "Failure responding to request")
		}
	}
	return
}
...
type Operation struct {
	// ID - READ-ONLY; Operation id: {provider}/{resource}/{operation}.
	ID *string `json:"id,omitempty"`
...
type OperationStatus struct {
	autorest.Response `json:"-"`
	// Status - The status of the long running operation. Possible values include: 'Running', 'Completed', 'Failed'
...
func (osVar OperationStatus) MarshalJSON() ([]byte, error) {
	...
	if osVar.ReportURL != nil {
		objectMap["properties"] = osVar.ReportURL
	}
	return json.Marshal(objectMap)
}
...
func (osVar *OperationStatus) UnmarshalJSON(body []byte) error {
	...
	for k, v := range m {
		...
		case "status":
			if v != nil {
				var status OperationStatusType
		...
		case "properties":
			if v != nil {
				...
				err = json.Unmarshal(*v, &reportURL)
				if err != nil {
					return err
				}
				osVar.ReportURL = &reportURL
			}
		}
	}
...
// QueryColumn queryColumn properties
...
type ViewProperties struct {
	...
	// DateRange - READ-ONLY; Date range of the current view.
	DateRange *string `json:"dateRange,omitempty"`
	// Currency - READ-ONLY; Currency of the current view.
	...
	for k, v := range m {
		...
		case "dateRange":
			if v != nil {
				...
				err = json.Unmarshal(*v, &dateRange)
				if err != nil {
					return err
				}
				vp.DateRange = &dateRange
			}
		case "currency":
			if v != nil {
				var currency string
